            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('stocks.export') }}" class="btn btn-primary btn-sm" title="Export for Stock Opname">
                ...
                <form action="{{ route('stocks.adjust') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <small>For normal receiving use <strong>Bon In</strong>, for issuing use <strong>Bon Out</strong>.</small>
                        </div>
