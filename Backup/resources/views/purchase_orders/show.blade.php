                        ...
                        @if ($purchaseOrder->status === 'on_progress')
                            @php
                                ...
                                if ($purchaseOrder->total_amount > $amountThreshold) {
                                    ...
                                    $canApprove = auth()
                                        ->user()
                                        ->hasAnyRole(['manager', 'director', 'super_admin']);
                                }
                            ...
                            @else
                                <span class="badge badge-warning">
                                    ...
                                    @else
                                        Manager approval required (≤Rp 5,000,000)
                                    @endif
                                </span>
                            @endif
                        @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-sm">
                                ...
                                <tr>
                                    <th>Total Amount:</th>
                                    <td><strong>Rp {{ number_format($purchaseOrder->total_amount, 0, ',', '.') }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Expected Delivery:</th>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ucfirst($purchaseOrder->pembayaran) }}</td>
                                </tr>
                        ...
                        @if ($purchaseOrder->purchaseInvoices->isNotEmpty())
                            ...
                            @foreach ($purchaseOrder->details as $detail)
                                <tr>
                                    @if ($purchaseOrder->po_type === 'service_order')
                                        ...
                                        <td><strong>Rp {{ number_format($detail->total_price, 0, ',', '.') }}</strong></td>
                                    @else
                                        ...
                                        <td>
                                            ...
                                            @if ($detail->shortage_close_reason)
                                                <div><small class="text-muted">{{ $detail->shortage_close_reason }}</small>
                                                </div>
                                            @endif
                                        </td>
                                    @endif
                            ...
                            <div class="col-md-6 offset-md-6">
                                <table class="table table-sm">
                                    ...
                                    @foreach ($purchaseOrder->miscCosts as $misc)
                                        <tr>
                                            <th class="text-muted font-weight-normal pl-3">↳ {{ $misc->description }}:</th>
