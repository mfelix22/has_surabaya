                                ...
                                @else
                                    @foreach ($lines as $idx => $line)
                                        @php
                                            ...
                                            $oldA1 = old("lines.{$idx}.approver1_id");
                                            $oldA2 = old("lines.{$idx}.approver2_id");
                                            $oldA3 = old("lines.{$idx}.approver3_id");
                                        @endphp
                                        <div class="card card-outline card-info mb-3" id="card-{{ $idx }}">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div id="approvers-{{ $idx }}" class="mt-3"
                                                    ...
                                                    <div id="lt20-{{ $idx }}"
                                                        ...
                                                        <div class="alert alert-warning py-1 mb-2" style="font-size:.85em;">
                                                            <i class="fas fa-info-circle"></i> Under 20% — any one of 3
                                                            approvers is sufficient.
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1">
                                                                    <label class="small">Approver 1 <span
                                                                            class="text-danger">*</span></label>
                                                                    <select name="lines[{{ $idx }}][approver1_id]"
                                                                        id="lt20-a1-{{ $idx }}"
                                                                        class="form-control form-control-sm select2"
                                                                        {{ $oldPct > 0 && $oldPct < 20 ? '' : 'disabled' }}>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1">
                                                                    <label class="small">Approver 2 <span
                                                                            class="text-danger">*</span></label>
                                                                    <select name="lines[{{ $idx }}][approver2_id]"
                                                                        id="lt20-a2-{{ $idx }}"
                                                                        class="form-control form-control-sm select2"
                                                                        {{ $oldPct > 0 && $oldPct < 20 ? '' : 'disabled' }}>
                                                                        <option value="">— Select —</option>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group mb-1">
                                                                    <label class="small">Approver 3 <span
                                                                            class="text-danger">*</span></label>
                                                                    <select
                                                                        name="lines[{{ $idx }}][approver3_id]"
                                                                        id="lt20-a3-{{ $idx }}"
                                                                        class="form-control form-control-sm select2"
                                                                        {{ $oldPct > 0 && $oldPct < 20 ? '' : 'disabled' }}>
                                                                        <option value="">— Select —</option>
                                                    ...
                                                    <div id="gte20-{{ $idx }}"
                                                        ...
                                                        <div class="alert alert-danger py-1 mb-2"
                                                            ...
                                                            <i class="fas fa-exclamation-triangle"></i> 20% or above — both
                                                            must approve in sequence.
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1">
                                                                    <label class="small">Approver 1 — Manager / Accounting
                                                                        <span class="text-danger">*</span></label>
                                                                    <select
                                                                        name="lines[{{ $idx }}][approver1_id]"
                                                                        id="gte20-a1-{{ $idx }}"
                                                                        class="form-control form-control-sm select2"
                                                                        {{ $oldPct >= 20 ? '' : 'disabled' }}>
                                                                        <option value="">— Select —</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1">
                                                                    <label class="small">Approver 2 — Director <span
                                                                            class="text-danger">*</span></label>
                                                                    <select
                                                                        name="lines[{{ $idx }}][approver2_id]"
                                                                        id="gte20-a2-{{ $idx }}"
                                                                        class="form-control form-control-sm select2"
                                                                        {{ $oldPct >= 20 ? '' : 'disabled' }}>
                                                                        <option value="">— Select —</option>
                                                ...
                                                <p class="text-muted small mt-2 mb-0"
                                                    ...
                                                    style="{{ $oldPct > 0 ? 'display:none;' : '' }}">
                                                    <i class="fas fa-arrow-up"></i> Enter a discount percentage to
                                                    configure approval.
                                                </p>
                                            </div>
                                        </div>
